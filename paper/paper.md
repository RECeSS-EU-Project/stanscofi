...
Using that package, one can test algorithms from the literature and more quickly develop a benchmark pipeline, which we demonstrated by the implementation of the **benchscofi** package. 
