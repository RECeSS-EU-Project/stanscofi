...
class TestDatasets(unittest.TestCase):
    ...
    def test_dummy_dataset(self):
        ...
        self.assertEqual(data_args["users"].shape[0], npositive+nnegative)
        self.assertEqual(data_args["items"].shape[0], nfeatures//2)
        self.assertEqual(data_args["items"].shape[0], npositive+nnegative)
    ...
    def test_existing_dataset(self):
        sb.Popen("mkdir -p datasets/".split(" "))
    ...
    def test_new_dataset(self):
        ...
        self.assertEqual(dataset.users.shape[0], npositive+nnegative)
